...
SERVER_PORT_MAP =  {'Alford':18485,'Ball':18486,'Hamilton':18487,'Holiday':18488,'Welsh':18489}
...
class ServerHerdTest(unittest.TestCase):
    ...
    def test_duplicate_iamat_handling(self):
        ...
        second_at = do_communicate('Holiday', b'WHATSAT %s +34.068930-118.445127 %b\n' % (
            client_id.encode(), ("%.9f" % (now - 1000)).encode()))
    ...
    def test_basic_location_propagation(self):
        ...
        self.assertEqual(first_at.decode(),second_at.decode())
